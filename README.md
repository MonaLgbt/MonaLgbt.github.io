...
Offline verwenden
Repository `reveal.js` klonen: `git clone https://github.com/hakimel/reveal.js.git`
In `index.html` die CDN‑Links durch lokale Pfade ersetzen (z. B. `./reveal.js/dist/reveal.css`).
Hinweise
