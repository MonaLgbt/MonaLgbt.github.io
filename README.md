...
Sie sind so weit wie rechtlich möglich gemeinfrei gestellt und dürfen frei verwendet,  
verändert und weitergegeben werden, ohne dass eine Namensnennung erforderlich ist.

Einzelne Präsentationsbilder wurden von Unsplash (https://unsplash.com) bezogen  
und dürfen gemäß den dortigen Lizenzbedingungen frei verwendet werden.
...
[Link](https://monalgbt.github.io/pages/Dingsi.html)
