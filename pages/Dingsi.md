...
> **Eingeschränkt heißt nicht:** dass man nicht überall, wo Texteingabe möglich ist, ein vollständiges Markdown mit allen Möglichkeiten  
schreiben könnte. Man muss es nur abspeichern, und sich irgendwo einen Renderer suchen. Dann ist wieder alles chic.  
...
Das ist wohl dieselbe Denke wie z.B. in Word, wenn selten genutzte Funktionen versteckt werden. Unnötig deshalb, weil es nicht verwirren würde, da es einfach nicht zu sehen wäre. Stattdessen ist es nicht vorhanden.
